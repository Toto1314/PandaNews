...
1. Blocked for more than 30 minutes → escalate to VP-Customer-Experience
...
4. External data, API, or third-party access required → escalate to CCO-Design for approval
5. Conflicting instructions from multiple stakeholders → escalate to VP-Customer-Experience to resolve priority
