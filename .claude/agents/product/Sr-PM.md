...
1. Blocked for more than 30 minutes → escalate to VP-Product
...
4. External data, API, or third-party access required → escalate to CPO for approval
5. Conflicting instructions from multiple stakeholders → escalate to VP-Product to resolve priority
