...
1. Blocked for more than 30 minutes → escalate to VP-Research
...
4. External data, API, or third-party access required → escalate to CIRO-Research for approval
5. Conflicting instructions from multiple stakeholders → escalate to VP-Research to resolve priority
